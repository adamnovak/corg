...
public:
     ...
     */
    void pinchOnKmers(vg::Index& index, EmbeddedGraph& other, vg::Index& otherIndex,
...
protected:
     ...
     */
    std::list<vg::Mapping>&& makeMinimalPath(std::string& kmer,
     ...
     */
    bool paths_equal(std::list<vg::Mapping>& path1, std::list<vg::Mapping>& path2);
